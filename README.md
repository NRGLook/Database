...
11. **История покупок (Purchase History)**:
...
11. **История покупок (PurchaseHistory)**
   - Поля:
     - Идентификатор (ID): integer, primary key, auto-increment.
...
## 5. Схема:
![image](https://github.com/NRGLook/Database/assets/91383841/fa1221c5-5cb7-45ec-9723-818ff62a6876)
